        ...
        <div className="flex items-center space-x-4">
          {!user ? (
            <div className="hidden lg:flex space-x-4">
              <Link
                to="/login"
                className={` px-6 py-3 text-white font-semibold rounded-lg shadow-md bg-[#f39c12]  
                  hover:bg-[#e68a00] transition-all duration-300`}
              >
                Login
              </Link>
              <Link
            ...
            <div className="group relative flex items-center ">
              ...
              />
              <div
                className={`z-10 absolute top-8 right-0 mt-2 hidden group-hover:block w-48  bg-[#333] text-white rounded shadow-lg`}
              >
